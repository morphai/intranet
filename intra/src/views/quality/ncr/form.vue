    ...
    <v-form>
      <v-card :loading="loading">
        ...
        <v-card-text>
          ...
          <v-text-field v-model="form.defect" outlined label="불량현상" required></v-text-field>
          <v-text-field v-model="form.issuePlace" outlined label="발생장소" required></v-text-field>
          <v-text-field type="date" v-model="form.issueDate" outlined label="발생일자" required></v-text-field>
          <v-text-field v-model="form.dataSheet" outlined label="8D Report"> required</v-text-field>
        </v-card-text>
      </v-card>
    </v-form>
  </v-container>
...
export default {
  ...
  methods: {
    async fetch () {
      ...
      this.form.defect = item.defect
      this.form.issuePlace = item.issuePlace
    ...
    async save () {
      ...
      try {
        ...
        const doc = {
          ...
          defect: this.form.defect,
          issuePlace: this.form.issuePlace,
