    ...
    <v-form>
      <v-card :loading="loading">
        ...
        <v-card-text>
          ...
          <v-text-field v-model="form.result" outlined label="결과판정" required></v-text-field>
          <v-text-field type="date" v-model="form.issueDate" outlined label="등록일자" required></v-text-field>
          <v-text-field v-model="form.dataSheet" outlined label="Report"> required</v-text-field>
        </v-card-text>
      </v-card>
    </v-form>
  </v-container>
