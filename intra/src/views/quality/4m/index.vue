  ...
  <div>
    ...
    >
      ...
      <template v-slot:item.dataSheet1="{item}">
        <v-chip color="green" text-color="white" icon :href="item.dataSheet1" target="_blank"><v-icon left>mdi-file</v-icon>4M file</v-chip>
      </template>
      <template v-slot:item.dataSheet2="{item}">
        <v-chip color="green" text-color="white" icon :href="item.dataSheet2" target="_blank"><v-icon left>mdi-file</v-icon>file</v-chip>
      </template>
  ...
  data () {
    return {
      headers: [
        ...
        { value: 'reason', text: '변경사유' },
        { value: 'regDate', text: '등록일자' },
        { value: 'approvalDate', text: '승인일자' },
        { value: 'dataSheet1', text: '4M Sheet' },
        { value: 'dataSheet2', text: '검증 Data' },
