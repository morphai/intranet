    ...
    <v-form>
      <v-card :loading="loading">
        ...
        <v-card-text>
          ...
          <v-text-field v-model="form.toolNo" outlined label="Tooling No" required></v-text-field>
          <v-text-field v-model="form.customer" outlined label="고객 담당자" required></v-text-field>
          <v-text-field type="date" v-model="form.issueDate" outlined label="등록일자" required></v-text-field>
          <v-text-field v-model="form.dataSheet" outlined label="승인서류"> required</v-text-field>
        </v-card-text>
      </v-card>
    </v-form>
  </v-container>
